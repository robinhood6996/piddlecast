                    ...
                    <div className="col-12 col-lg-8 bg-white register-area-parent ">
                        ...
                        <div className="container d-flex justify-content-center">
                            ...
                            <div className="register-area mt-5">
                                ...
                                <div className="register-form">
                                    <Form>
                                        <Form.Group className="mb-3" controlId="formBasicEmail">
                                            <Form.Control type="text" className='input-custom' placeholder="Full Name" />
                                        </Form.Group>
                                        ...
                                        <Form.Group className="mb-3" controlId="formBasicPassword">
                                            <Form.Control className='input-custom' type="password" placeholder="Confirm Password" />
                                        </Form.Group>
                                ...
                                <p className='mt-4'>Already have an account? <span><a className='link' href="#">Log In</a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
